...
{
    // Fonction pour renvoyer tous les camions d'un transporteur
    public function index(Request $request, $key)
    {
        ...
        $camions = Camion::where('idtransporteur', $transporteur->id)->get();
    ...
    // Fonction pour afficher page détails d'un camion
}
